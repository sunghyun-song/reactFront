  ...
  constructor(props) {
    ...
    Axios.post("/api/pjs").then((response) => {
      if (response.data) {
        ...
        $("#scmcNm").text(response.data[0].pjNm);
        $("#scmcDtl").html(response.data[0].pjDtl);
              ...
              <CardColumns>
                <Card>
                  ...
                  <Card.Body class="cardBody">
                    <Card.Title id="scmcNm">
                      성남시의료원 2018.12 ~ 2018.08
                    </Card.Title>
                    <Card.Text id="scmcDtl">
                      2019년 성남시의료원 프로젝트 진행 성남시의료원,
                      성남시의료원 진료협력센터, 성남시의료원 관리자페이지 개발
                      담당
                      <br></br>
                      <a href="https://www.scmc.kr/" target="_blank">
                ...
                <Card>
                  ...
                  <Card.Body class="cardBody">
                    <Card.Title>
                      LG U+ 무인매장셀프상담/가입 앱 2020.08 ~ 2021.05
                    </Card.Title>
                    <Card.Text>
                      2020년 스마트가입 프로젝트 진행 <br></br>
                      LG U + 스마트가입 앱 화면 및
